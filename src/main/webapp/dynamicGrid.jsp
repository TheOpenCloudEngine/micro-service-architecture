...
<%
    ...
    String moduleName = className.replace(".","-")+"-grid";
        ...
        <vaadin-grid id="expenses" frozen-columns="1">
            <table>
                <colgroup>
                    ...
                    %>
                    <col name="<%=fd.getName()%>" flex="2" min-width="260" sortable/>
                    <%
                        }
                    %>
                </colgroup>
                ...
                ready: function() {
                    ...
                    grid.then(function() {
                        ...
                        grid.columns[3].renderer = function(cell) {
                            cell.element.innerHTML = cell.data.toFixed(2) + '원';
                        };
